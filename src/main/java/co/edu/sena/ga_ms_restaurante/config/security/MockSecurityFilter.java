...
public class MockSecurityFilter extends OncePerRequestFilter {
    ...
    private static final String HEADER_USER_ID   = "X-Mock-User-Id";
    private static final String HEADER_USER_ROLE = "X-Mock-User-Role";
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            try {
                ...
                log.warn("X-Mock-User-Id inválido: '{}', usando default", rawId);
            ...
            log.debug("MockSecurityFilter — userId: {}, role: {}", userId, role);
